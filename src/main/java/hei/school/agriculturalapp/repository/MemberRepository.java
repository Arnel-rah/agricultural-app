...
public class MemberRepository {
    ...
    public Member save(Member member) throws SQLException {
        String sql = "INSERT INTO member (first_name, last_name, birth_date, gender, address, profession, phone_number, email, registration_fee_paid, membership_dues_paid, admission_status, join_date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'APPROVED', CURRENT_DATE) RETURNING id";
